...
document.addEventListener('DOMContentLoaded', function () {
  const quotes = [
    ...
    '"Encrypt, Share, and Safeguard Effortlessly"',
    '"Your Personal Encryption Tool, Just a Tap Away"',
    '"Secure Your Files on the Go"'
  ];
  ...
  function showNextQuote() {
    ...
    // After fade out, update the quote and fade it back in
    setTimeout(() => {
  ...
  setInterval(showNextQuote, 5500); // Change quote every 5 seconds
});
